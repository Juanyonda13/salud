    ...
    <section class="body container-fliud d-flex col-12">
        ...
        <section class="col-10 d-flex border">
            ...
            <div class="card h-75 w-75">
                <form class="" method="POST" action="{{route('paciente.update',$paciente)}}">
                    @method ('PUT')
                    @csrf
                    <div class="m-3">
                        <label class="form-label" for="">Nombres</label>
                        <input type="text" class="form-control" name="nombre_paciente" id="nombre_paciente" tabindex="3" value="{{$paciente->nombre_paciente}}">
                    </div>
                    <div class="m-3">
                        <label class="form-label" for="">Apellidos</label>
                        <input type="text" class="form-control" name="apellido_paciente" id="apellido_paciente" tabindex="3" value="{{$paciente->apellido_paciente}}">
                    </div>
                    <div class="m-3">
                    ...
                    <div class="m-3">
                        ...
                        <input type="text" class="form-control" name="direccion_paciente" id="direccion_paciente" value="{{$paciente->direccion_paciente}}">
                    </div>
                    <div class="m3">
